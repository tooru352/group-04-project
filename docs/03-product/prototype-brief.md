...
- PA-001: Prototype dùng sample account cho Learner và Instructor, không có authentication thật.
...
**Screens bắt buộc:**
`Login`, `Learner Dashboard`, `Course List`, `Course Detail`, `Lesson Detail`, `Assignment Detail`, `Submission / Submit Assignment`, `Submission Result`, `Instructor Dashboard`, `Submission Review / Grading`, `Feedback`, `AI Tutor`.
